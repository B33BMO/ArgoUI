...
async function inlineRelativeResources(html: string, basePath: string): Promise<string> {
  ...
  // 1. <img src="relative"> -> base64 / Handle <img src="relative"> -> base64
  ...
  // 2. <link href="relative" rel="stylesheet"> -> <style> / Handle CSS links -> inline <style>
  ...
  // 3. <script src="relative"> -> inline <script> / Handle script tags -> inline
...
const HTMLRenderer: React.FC<HTMLRendererProps> = ({
  ...
  const [inlinedHtmlContent, setInlinedHtmlContent] = useState<string>(''); // HTML/ Inlined HTML (for browser iframe)
