...
export const PreviewProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    (tabList: PreviewTab[], type: PreviewContentType, content?: string, meta?: PreviewMetadata) => {
      ...
      return (
        tabList.find((tab) => {
          ...
          // filePath / Prefer matching by filePath (most reliable)
          ...
          // content / Finally match by content (only for small files)
          // PPT/Excel/Word content
  ...
  // preview.open / Listen to preview.open event (for agent to open web preview)
  ...
  useEffect(() => {
    ...
    // IPC / Listen to IPC event (from main process, e.g., chrome-devtools MCP navigation)
