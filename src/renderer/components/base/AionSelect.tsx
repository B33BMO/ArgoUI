...
export interface AionSelectProps extends NativeSelectProps {
  ...
  className?: string;
  /** middle32px/ Unified size with additional "middle" (32px)*/
  size?: AionSelectSize;
}

/**
 * arco-override.css .aion-select
 ...
 * ```tsx
 * Basic usage
 * <AionSelect placeholder="" style={{ width: 200 }}>
 * <AionSelect.Option value="1">1</AionSelect.Option>
 * <AionSelect.Option value="2">2</AionSelect.Option>
 * </AionSelect>
 *
 * Multiple selection
 * <AionSelect mode="multiple" placeholder="">
 * <AionSelect.Option value="1">1</AionSelect.Option>
 * <AionSelect.Option value="2">2</AionSelect.Option>
 * </AionSelect>
 *
 * Grouped options
 * <AionSelect placeholder="">
 * <AionSelect.OptGroup label="1">
 * <AionSelect.Option value="1">1</AionSelect.Option>
 *   </AionSelect.OptGroup>
 * <AionSelect.OptGroup label="2">
 * <AionSelect.Option value="2">2</AionSelect.Option>
 *   </AionSelect.OptGroup>
 * </AionSelect>
 * ```
