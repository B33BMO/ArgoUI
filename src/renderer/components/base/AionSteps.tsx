 ...
 * Basic usage
 * <AionSteps current={1}>
 * <AionSteps.Step title="1" description="" />
 * <AionSteps.Step title="2" description="" />
 * <AionSteps.Step title="3" description="" />
 * </AionSteps>
 *
 * Vertical steps
 ...
 * Steps with icons
 * <AionSteps current={1}>
 * <AionSteps.Step title="" icon={<IconCheck />} />
 * <AionSteps.Step title="" icon={<IconLoading />} />
 * <AionSteps.Step title="" icon={<IconClock />} />
 * </AionSteps>
 *
 * Mini steps
 * <AionSteps current={1} size="small" type="dot">
 * <AionSteps.Step title="1" />
 * <AionSteps.Step title="2" />
 * <AionSteps.Step title="3" />
 * </AionSteps>
 * ```
 *
