...
/**
 * Color scheme management hook Hook
...
const useColorScheme = (): [ColorScheme, (scheme: ColorScheme) => Promise<void>] => {
  ...
  /**
   * Apply color scheme to DOM DOM
   * Switch CSS variables by setting data-color-scheme attribute data-color-scheme CSS
   */
   ...
   * Updates state, DOM attribute and local storage DOM
   */
