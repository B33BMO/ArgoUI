...
export function registerApiRoutes(app: Express): void {
   ...
   * - Upload file
   * POST /api/upload
   * WebUI // HTTP multipart workspace
  ...
  /**
   * APIWebUI- Extension asset API (WebUI)
