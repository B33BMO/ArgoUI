 ...
 * System instructions string or undefined
 */
...
export async function prepareFirstMessage(content: string, config: FirstMessageConfig): Promise<string> {
  ...
  // Gemini Agent Claude/Codex agent
 ...
 *
 * ACP agents (Claude/OpenCode) CodexAgent Read skill
 ...
 * Original message content
 * First message configuration
 * Message content with injected instructions and loaded skills list
 */
 ...
 *
 * Gemini skill [LOAD_SKILL: skill-name]
 * skill [System Response]
 *
