...
export function initWebuiBridge(): void {
  ...
  // @office-ai/platform bridge provider
  // emitter resetPasswordResult
  ...
  // ===== IPC / Direct IPC handlers (bypass bridge library) =====
  // emitter
  ...
  // IPC: / Direct IPC: Change password (no current password required)
