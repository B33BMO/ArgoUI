...
const textColors = {
  ...
  't-tertiary': 'var(--bg-6)', // text-t-tertiary - /
...
// 📝 text-1 text-4 Arco --color-text-*
// text-1 to text-4 are supported via custom rules, pointing to Arco's --color-text-*
const backgroundColors = {
  base: 'var(--bg-base)', // bg-base, border-base -
  1: 'var(--bg-1)', // bg-1, border-1 -
  2: 'var(--bg-2)', // bg-2, border-2 -
  3: 'var(--bg-3)', // bg-3, border-3 - /
...
const borderColors = {
  ...
  'b-1': 'var(--bg-3)', // border-b-1 - bg-3
  'b-2': 'var(--bg-4)', // border-b-2 - bg-4
  'b-3': 'var(--bg-5)', // border-b-3 - bg-5
};
...
export default defineConfig({
  ...
  rules: [
    ...
    // Arco Design primary/success/warning/danger/link-light-1 -light-4
    ...
    // Arco Design primary/success/warning/danger 1-9
