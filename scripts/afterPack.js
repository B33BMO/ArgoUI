...
module.exports = async function afterPack(context) {
  ...
  const needsSameArchRebuild = electronPlatformName === 'win32'; // Windows Electron ABI | Only Windows needs same-arch rebuild to match Electron ABI
  // Linux GLIBC | Linux uses prebuilt binaries which are GLIBC-independent
